...
export default function GlassPanel({
  ...
  return (
    <div
      className={`rounded-xl border border-white/40 bg-surface-alt/5 p-6 shadow-[0_9px_25px_-12px_rgba(8,42,67,0.55)] backdrop-blur-[4px] backdrop-saturate-[1.2] sm:p-10 ${className}`}
    >
      {children}
    </div>
  )
